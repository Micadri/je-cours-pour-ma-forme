...
try {
    ...
    $stmtLog = $pdo->prepare("INSERT INTO session_logs (user_id, session_id, status, distance_meters) VALUES (?, ?, 'completed', ?)");
    $stmtLog->execute([$user['id'], $data['session_id'], $data['distance'] ?? 0]);
